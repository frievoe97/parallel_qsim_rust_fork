...
fn create_resources(out_dir: &PathBuf, plan_file: &str) {
...
fn execute_equil_single_part() {
    ...
    create_resources(&test_dir, "equil-1-plan.xml");
...
#[test]
#[serial_test::serial]
fn execute_equil_network_no_main_mode() {
    let test_dir = PathBuf::from("./test_output/simulation/equil_no_main/");
    create_resources(&test_dir, "equil-1-plan.xml");

    let config_args = CommandLineArgs {
        config_path: "./tests/resources/equil/equil-config-nomain.yml".to_string(),
        num_parts: None,
    };
...
#[test]
#[serial_test::serial]
fn execute_equil_generic_no_main_mode() {
    let test_dir = PathBuf::from("./test_output/simulation/equil_no_main/");
...
#[test]
#[should_panic]
fn execute_equil_generic_main_mode() {
    let test_dir = PathBuf::from("./test_output/simulation/equil_with_main/");
    create_resources(&test_dir, "equil-1-plan-generic.xml");
